      ...
      <plugin>
        ...
        <executions>
          <execution>
            ...
            <configuration>
              <descriptors>
                <descriptor>mvn:org.hitachivantara.karaf.features/framework/4.0.4/xml/features</descriptor>
                <descriptor>file:${project.build.directory}/feature/feature.xml</descriptor>
              </descriptors>
              <distribution>org.hitachivantara.karaf.features:framework</distribution>
              <javase>1.8</javase>
              <framework>
      ...
      <plugin>
        ...
        <executions>
          <execution>
            ...
            <configuration>
              <descriptors>
                <descriptor>mvn:org.hitachivantara.karaf.features/standard/4.0.0/xml/features</descriptor>
